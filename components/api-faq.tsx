  ...
  return (
    <section className="mx-auto w-full max-w-3xl px-6 py-16">
      <div className="mb-10 text-center">
        <h2 className="text-2xl font-bold">{dict.apiFaq.title}</h2>
        <p className="mt-2 text-neutral-500 dark:text-neutral-400">{dict.apiFaq.subtitle}</p>
      </div>
      <div className="divide-y divide-neutral-200 rounded-2xl border border-neutral-200 bg-white dark:divide-neutral-800 dark:border-neutral-800 dark:bg-neutral-900">
        {dict.apiFaq.items.map((item, index) => {
